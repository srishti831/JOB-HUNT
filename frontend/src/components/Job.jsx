...
const Job = () => {
    ...
    const jobId = "24235gbgg";
  return (
    <div className = 'p-5 rounded-md shadow-xl bg-white border border-gray-100'>
        <div className = "flex items-center justify-between">

                 <p className='text-sm text-gray-500'>2 days ago</p>
        <Button variant = "outline" className = "rounded-full" size = "icons"><Bookmark/></Button>
        </div>
    ...
    <p className = 'tex-sm text-gray-600'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corrupti eveniet ipsam ipsa vitae nemo. Placeat ratione, doloribus doloremque similique culpa consectetur dolorum!</p>
        </div>
